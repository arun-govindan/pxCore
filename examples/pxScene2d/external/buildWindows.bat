...
cd vc.build\
msbuild external.sln /p:Configuration=Release /p:DebugSymbols=false /p:DebugType=None /p:Platform=Win32 /m
cd ..

cd breakpad-chrome_55
CALL gyp\gyp.bat src\client\windows\breakpad_client.gyp --no-circular-check
cd src\client\windows
msbuild breakpad_client.sln /p:Configuration=Release /p:DebugSymbols=false /p:DebugType=None /p:Platform=Win32 /verbosity:quiet /m
cd ..\..\..\..\
