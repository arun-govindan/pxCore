...
then
	...
	cmake -DSUPPORT_V8=ON -DSUPPORT_NODE=OFF -DSUPPORT_DUKTAPE=OFF -DBUILD_PX_TESTS=ON -DBUILD_PXSCENE_STATIC_LIB=ON -DBUILD_DEBUG_METRICS=ON -DPXSCENE_TEST_HTTP_CACHE=ON .. >>$BUILDLOGS 2>&1;
  ...
  cmake -DSUPPORT_V8=ON -DSUPPORT_NODE=OFF -DSUPPORT_DUKTAPE=OFF -DBUILD_PX_TESTS=ON -DBUILD_PXSCENE_STATIC_LIB=ON -DBUILD_DEBUG_METRICS=ON -DPXSCENE_TEST_HTTP_CACHE=ON .. 1>>$BUILDLOGS;
